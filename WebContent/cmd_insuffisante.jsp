...
<body>
 ...
 <div class="container tableAchats " style="text-align:center;padding:50px;">
	 	<h4>Desolé !</h4>
		<h4>La quantité du produit que vous avez demandé n'est pas disponible dans le stock </h4>
