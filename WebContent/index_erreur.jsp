...
<%
 ...
 try {
	 ...
	 String create = "CREATE TABLE IF NOT EXISTS usersession(matricule varchar(255) primary key,"+
			"nom varchar(255)," 
			+"prenom varchar(255),"
			+"email varchar(255),"
...
Swal.fire({
    title: 'Attention!',
    text: 'Si inscrit, Remplissez correctement les champs.',
    type: 'error',
